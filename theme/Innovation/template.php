                ...
                <div class="row">
                    ...
                    <div class="beside-items">
                        <div class="beside-item beside-item-aqua">
                            <img src="dist/img/aqua.jpg" alt="Аквапарк">
                            <div class="desc">
                                <b>Аквапарк</b>
                        ...
                        <div class="beside-item beside-item-bridge">
                            <img src="dist/img/krum.jpg" alt="Аквапарк">
                            <span class="distance">80<span>км</span></span>
                            <div class="desc">
                                <b>Крым</b>
                        ...
                        <div class="beside-item beside-item-para">
                            <img src="dist/img/paraplane.jpg" alt="Аквапарк">
                            <span class="distance">80<span>км</span></span>
                            <div class="desc">
                                <b>Парапланеризм</b>
                        ...
                        <div class="beside-item beside-item-fish">
                            <img src="dist/img/river.jpg" alt="Аквапарк">
                            <span class="distance">80<span>км</span></span>
                            <div class="desc">
                                <b>Рыбалка</b>
                        ...
                        <div class="beside-item beside-item-wear">
                            <img src="dist/img/field.jpg" alt="Аквапарк">
                            <div class="desc">
                                <b>Кавказские горы</b>
                        ...
                        <div class="beside-item beside-item-volcan">
                            <img src="dist/img/source.jpg" alt="Аквапарк">
                            <span class="distance">80<span>км</span></span>
                            <div class="desc">
                                <b>Грязевой лечебный вулкан «Тиздар»</b>
                            </div>
                        </div>
                        <div class="beside-item beside-item-text hidden-xs hidden-md">
                            <p>lorem</p>
                        </div>
                        <div class="beside-item beside-item-serf">
                            <img src="dist/img/windsurfing.jpg" alt="Аквапарк">
                            <span class="distance">80<span>км</span></span>
                            <div class="desc">
                                <b>Аквапарк</b>
                                <i>Большой и красивый акварк</i>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="infrastructure-items">
                            <div class="infrastructure-item water">
                                <p>Чистая фильтрованная вода в кране</p>
                            </div>
                            <div class="infrastructure-item eco">
                                <p>Экологически чистые продукты местного производства</p>
                            </div>
                            <div class="infrastructure-item sun">
                                <p>Огромное количество солнечных дней в году</p>
                            </div>
                            <div class="infrastructure-item tennis">
                                <p>Свой теннисный корт</p>
                            </div>
                            <div class="infrastructure-item children">
                                <p>Организованная детская площадка</p>
                            </div>
                            <div class="infrastructure-item beach">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="hidden-xs hidden-sm hidden-md houses-about houses_about-1">
                            ...
                            <div class="houses-about-details">
                                <img src="/dist/img/houses-about-details.jpg" alt="">
                                <table>
                                    <tr>
                                        <td>Площадь:</td>
                                ...
                                <div class="btn_group">
                                    <button class="btn btn_red">Подробнее о технология</button>                                        
                                    <button class="btn btn_red">Хочу здесь жить!</button>
                                </div>
                            </div>
                            <div class="houses-about-gallery">
                                <div class="houses-about-gallery-item">
                                    <img src="/dist/img/houses-about-gallery-1.png" alt="">
                                </div>
                                <div class="houses-about-gallery-item">
                                    <img src="/dist/img/houses-about-gallery-2.png" alt="">
                                </div>
                                <div class="houses-about-gallery-item">
                                    <img src="/dist/img/houses-about-gallery-3.png" alt="">
                                </div>
                                <div class="houses-about-gallery-item">
                                    <img src="/dist/img/houses-about-gallery-4.png" alt="">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="plan-gallery_group">
                                <img src="/dist/img/plan-1.jpg" alt="Изображение дома">
                                <img src="/dist/img/plan-2.jpg" alt="Изображение дома">
                                <img src="/dist/img/plan-3.jpg" alt="Изображение дома">
                                <img src="/dist/img/plan-4.jpg" alt="Изображение дома">
                            </div>
                        ...
                        <div class="swiper-container village-swiper">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="/dist/img/slider-first-1.jpg" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img src="/dist/img/slider-first-2.jpg" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img src="/dist/img/slider-first-3.jpg" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img src="/dist/img/slider-first-4.jpg" alt="">
                                </div>
                            </div>
        ...
        <section class="accomplishment">
            ...
            <div class="accomplishment-items">
                ...
                <div class="accomplishment-item-float">
                    ...
                    <div class="btn_grop">
                        <button class="btn btn_red-light">Хочу здесь жить!</button>
                    </div>
                </div>
            </div>
        </section>
